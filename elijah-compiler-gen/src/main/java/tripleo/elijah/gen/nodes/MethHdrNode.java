...
public class MethHdrNode implements Node {
	...
	final public @NonNull   MethNameNode       methName;
	private final @Nullable TypeRef            returnType2;
	private final           Node               _parent;
	private final @NonNull  List<ArgumentNode> argument_types;
	private final           int                _code;
	public                  int                argCount;
	public @Nullable        TypeNameNode       returnType;

	public MethHdrNode(final Node parent, @NonNull final IdentExpression return_type, final String method_name, final @NonNull List<ArgumentNode> argument_types, final int code) {
		_parent             = parent;
		_code               = code;
	...
	public MethHdrNode(final TypeRef retType, final Node parent, final String methodName, final @NonNull List<ArgumentNode> argumentTypes, final int code) {
		_parent        = parent;
		_code          = code;
	...
	public @NonNull Iterable<ArgumentNode> ArgumentsIterator() {
		// TODO Auto-generated method stub
		return new Iterable<ArgumentNode>() {

			@Override
			public @NonNull Iterator<ArgumentNode> iterator() {
