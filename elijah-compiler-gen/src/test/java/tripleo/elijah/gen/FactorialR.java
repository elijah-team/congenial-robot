...
//		super(name);
	...
	void main2_el(final CompilerContext cctx, final @NonNull GenBuffer gbn) {
	...
	private @NonNull NumericExpression convertToLocalAgnTmpNode2(final IExpressionNode fncall) {
		throw new NotImplementedException();
	}

	private List<LocalAgnTmpNode> convertToLocalAgnTmpNode(final List<@NonNull NumericExpression> list_of) {
...
//		return r;
	...
	public void factorial_r(final @NonNull CompilerContext cctx, final @NonNull GenBuffer gbn) {
		final ModuleRef prelude = new ModuleRef(null, -1);
...
*/
	...
	public void GenMethHdr(final @NonNull CompilerContext cctx, final @NonNull MethHdrNode node, final @NonNull GenBuffer gbn) {
	...
	private void BeginMeth(final @NonNull CompilerContext cctx, final @NonNull MethHdrNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
...
*/
	...
	private void BeginCaseStatement(final @NonNull CompilerContext cctx, final @NonNull CaseHdrNode node, final @NonNull GenBuffer gbn) {
		final TextBuffer buf = gbn.moduleBufImpl(cctx.module());
	...
	private void BeginCaseChoice(final @NonNull CompilerContext cctx, final @NonNull CaseChoiceNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
	...
	private void GenReturnAgn(final @NonNull CompilerContext cctx, final @NonNull ReturnAgnNode node, final @NonNull GenBuffer gbn) {
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.append("vsr =");
		buf.append(node.getExpr().genText(cctx));
		buf.append_ln(";");
	...
	private void CloseCaseChoice(final @NonNull CompilerContext cctx, final CloseCaseNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf = gbn.moduleBufImpl(cctx.module());
		buf.decr_i();
		buf.append_ln("break; }");
//		buf.append_nl("} // close select ("+node.hdr_node.left.genName+")"); // TODO left was expr
	...
	private void BeginDefaultCaseStatement(final @NonNull CompilerContext cctx, final @NonNull CaseChoiceNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.incr_i();
...
*/
	...
	public static @NonNull TextBuffer BeginTmpSSACtx(final @NonNull CompilerContext cctx, final @NonNull TmpSSACtxNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.incr_i();
		buf.append_ln("{");
...
//			buf.append(node._tmp.genName());
	...
	public static @NonNull TextBuffer GenLocalAgn(final @NonNull CompilerContext cctx, final @NonNull LocalAgnTmpNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
...
//		}
	...
	private void CloseTmpCtx(final @NonNull CompilerContext cctx, final LocalAgnTmpNode lamn, final @NonNull GenBuffer gbn) {
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.append_cb(""); // close-brace
	}
	
	private void EndCaseStatement(final @NonNull CompilerContext cctx, final @NonNull CaseHdrNode node, final @NonNull GenBuffer gbn) {
		// TODO Auto-generated method stub
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.decr_i();
	...
	private void EndMeth(final @NonNull CompilerContext cctx, final MethHdrNode mhn, final @NonNull GenBuffer gbn) {
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
	...
	@Deprecated
	private void GenReturnAgnSimpleInt(final @NonNull CompilerContext cctx, final @NonNull ReturnAgnSimpleIntNode rasin, final @NonNull GenBuffer gbn) {
		final TextBuffer buf=gbn.moduleBufImpl(cctx.module());
		buf.append("vsr = ");
...
//		@Override
		@Override
		public void transform(final @NonNull ArgumentNode na, final @NonNull DefaultBuffer bufbldr) {
