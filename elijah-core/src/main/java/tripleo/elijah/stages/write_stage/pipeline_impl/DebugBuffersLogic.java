...
public enum DebugBuffersLogic {
	...
	public static void __debug_buffers_logic_each(final @NonNull XPrintStream db_stream, final @NonNull Old_GenerateResultItem ab) {
		if (true) {
	...
	public static void debug_buffers_logic(final @NonNull GenerateResult result, final @NonNull XPrintStream db_stream) {
