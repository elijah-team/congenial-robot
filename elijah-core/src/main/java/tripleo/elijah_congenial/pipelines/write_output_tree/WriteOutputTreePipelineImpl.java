...
public class WriteOutputTreePipelineImpl {
	//private final WriteOutputTreePipelineImpl_IPipelineAccess pa;

	public WriteOutputTreePipelineImpl(final WriteOutputTreePipelineImpl_IPipelineAccess aPipelineAccess) {
		//pa = aPipelineAccess;
	}
