...
public class Thinlet extends Container implements Runnable, Serializable {
	...
	private static @Nullable ResourceBundle langResource        = null; // for I18N
	private static @Nullable ResourceBundle langResourceDefault = null; // for I18N
	private static           long           WHEEL_MASK          = 0;
	private static           int            MOUSE_WHEEL         = 0;
	private static @Nullable Method         wheelrotation       = null;
	...
	static {
		...
		dtd = new Object[]{
				...
				"spinbox", "textfield",
				new Object[][]{
						{"integer", "minimum", null, Integer.valueOf(Integer.MIN_VALUE)},
						{"integer", "maximum", null, Integer.valueOf(Integer.MAX_VALUE)},
				...
				"column", "choice",
				new Object[][]{
						{"integer", "width", null, Integer.valueOf(80)},
	...
	private final transient @Nullable Color c_ctrl = null;
	private transient                 int   block;
	private transient @Nullable Image hgradient, vgradient;
	...
	private transient @Nullable Object insidepart;
	private transient @Nullable Object mousepressed;
	private transient @Nullable Object pressedpart;
	private transient           int    referencex, referencey;
	private transient int mousex, mousey;
	private transient @Nullable Object  focusowner;
	private transient           boolean focusinside;
	private transient @Nullable Object  popupowner;
	private transient @Nullable Object  tooltipowner;
	 ...
	 * popupmenu, etc ...
	 */
	protected static @Nullable Object get(Object component, Object key) {
	 ...
	 * @return the value, or null
	 */
	protected static @Nullable String getDOMText(Object node) {
	 ...
	 */
	private static @Nullable Object getItemImpl(Object component, Object key, int index) {
		int i = 0;
	 ...
	 *
	 */
	protected static boolean set(Object component, Object key, @Nullable Object value) {
	 ...
	 */
	private @Nullable String getAccelerator(Object component) {
	 ...
	 */
	private @Nullable Object popupMenu(Object component) {
	 ...
	 */
	private void closeCombo(Object combobox, Object combolist, @Nullable Object item) {
	...
	private void paint(@NotNull Graphics g, int clipx, int clipy, int clipwidth, int clipheight, Object component,
		...
		if ("label" == classname) {
			...
			paintScroll(component, ":combolist", pressed, inside, focus, enabled, g, clipx, clipy, clipwidth, clipheight);
		} else if (("textfield" == classname) || ("passwordfield" == classname)) {
			...
			paintScroll(component, "textarea", pressed, inside, focus, enabled, g, clipx, clipy, clipwidth, clipheight);
		} else if ("tabbedpane" == classname) {
			int     i           = 0;
	 ...
	 * separators, or null
	 */
	private @Nullable Object getMenu(Object component, Object part, boolean forward, boolean popup) {
		Object previous = null;
	 ...
	 */
	public static @Nullable String getClass(Object component) { //#
	 ...
	 */
	private @Nullable Object findText(char keychar, Object component, Object leadowner, boolean recursive) {
		if (keychar != 0) {
			long current = System.currentTimeMillis();
	 ...
	 */
	private @Nullable Object getNextItem(Object component, Object item, boolean recursive) {
		if (!recursive) {
	...
	protected void invokeImpl(Object method, Object part) {
		...
		if (args != null) for (int i = 0; i < args.length; i++) {
			...
			if ("tripleo/vendor/thinlet/thinlet" == target) {
				args[i] = this;
			} else {
				if ("item" == target) {
					target = part;
	 ...
	 *
	 */
	private @Nullable Object getListItem(Object component, Object scrollpane, int keycode, @Nullable Object lead, boolean recursive) {
		Object row = null;
		if (keycode == KeyEvent.VK_UP) {
	 ...
	 *
	 */
	@Nullable Rectangle getRectangle(Object component, String key) {
	 ...
	 */
	private void setLead(Object component, @Nullable Object oldlead, Object lead) {
		if (oldlead != lead) { //?
			if (oldlead != null) {
	 ...
	 */
	private void setInside(Object component, @Nullable Object part, boolean scroll) {
	...
	private void handleMouseEvent(int x, int y, int clickcount, boolean shiftdown, boolean controldown,
								  boolean popuptrigger, int id, Object component, @Nullable Object part) {
		if (id == MouseEvent.MOUSE_ENTERED) {
			setTimer(750L);
		} else if (id == MouseEvent.MOUSE_EXITED) {
			hideTip();
		...
		if (("list" == classname) || ("table" == classname) || ("tree" == classname)) {
			...
			int       modifiers = 0;
			if (shiftdown) modifiers |= InputEvent.SHIFT_MASK;
			if (controldown) modifiers |= InputEvent.CTRL_MASK;
			if (id == MouseEvent.MOUSE_PRESSED || id == MouseEvent.MOUSE_RELEASED || id == MouseEvent.MOUSE_EXITED
				...
				bean.dispatchEvent(new MouseEvent(this, id, System.currentTimeMillis(), modifiers, ((Integer) get(
						component, ":mousex")).intValue(), ((Integer) get(component, ":mousey")).intValue(),
			...
			if (part == null) {
				...
				if ((id == MouseEvent.MOUSE_ENTERED) || (id == MouseEvent.MOUSE_EXITED)
					...
					repaint(component, "spinbox", part);
				}
			}
		} else if ("tabbedpane" == classname) {
			if ((id == MouseEvent.MOUSE_ENTERED) || (id == MouseEvent.MOUSE_EXITED)) {
			...
			if (((id == MouseEvent.MOUSE_ENTERED) || (id == MouseEvent.MOUSE_EXITED)) && (part != null)
				...
				repaint(component, "menubar", part);
			} else if ((part != null)
	 ...
	 */
	private void setReference(@Nullable Object component, int x, int y) {
		referencex = x;
		referencey = y;
	 ...
	 */
	private @Nullable Object getPreviousFocusable(@Nullable Object component, Object block, boolean start, boolean upward,
	 ...
	 * component
	 */
	private @Nullable Object findNextItem(Object component, String classname, @Nullable Object item) {
	 ...
	 *
	 */
	private int getIndex(Object component, @Nullable Object value) {
	 ...
	 */
	private boolean checkMnemonic(@Nullable Object component, boolean parent, Object checked, int keycode, int modifiers) {
		...
		if (parent && (("dialog" != classname) || !getBoolean(component, "modal", false))) {
			return checkMnemonic(getParent(component), true, ("tab" == classname) ? checked : component, keycode,
								 modifiers);
		}
		return false;
	}
	...
	private boolean setChoice(Object component, String key, @Nullable String value, String @NotNull [] values, String defaultvalue) {
		...
		for (String value2 : values) {
			if (value.equals(value2)) {
				return set(component, key, value2);
			}
		}
	 ...
	 *
	 */
	private void setKeystrokeImpl(Object component, String key, @Nullable String value) {
		Long keystroke = null;
		if (value != null) {
			String token = value;
			try {
	 ...
	 *
	 */
	public @Nullable Object getWidget(Object component, String key) {
	 ...
	 *
	 */
	private @Nullable String getI18NString(Object component, String key, String text) { // for
		// I18N
		if (allI18n && (langResource != null) && ((key == "text") || (key == "tooltip"))
	 ...
	 */
	public void putProperty(Object component, Object key, @Nullable Object value) {
		Object table = get(component, ":bind");
		if (value != null) {
			if (table == null) {
	 ...
	 * @return the loaded image or null
	 */
	public @Nullable Image getIcon(@Nullable String path, boolean preload) {
