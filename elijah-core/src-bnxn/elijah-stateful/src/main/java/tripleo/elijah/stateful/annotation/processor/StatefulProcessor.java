...
public class StatefulProcessor extends AbstractProcessor {
	...
	private static void extracted(final Map<String, String> setterMap,
...

		{
			...
			javaClass.setPackage("com.company.example").setName(simpleClassName + "__STX");

//			javaClass.addInterface(State.class);
			javaClass.addInterface("tripleo.elijah.stateful.State");

			javaClass.addField()
					.setName("identity")
					.setType("StateRegistrationToken")
					.setPrivate();
			...
			javaClass.addMethod()
					...
					.setName("apply")
					.setReturnTypeVoid()
					.setBody("//implementation here")
					.addParameter("DefaultStateful", "element");
			...
			javaClass.addMethod()
					...
					.setName("setIdentity")
					.setReturnTypeVoid()
					.setBody("identity = aId;")
					.addParameter("StateRegistrationToken", "aId");
			...
			final String s = javaClass.toString();
...
//			javaClass.addInterface(State.class);
			...
			javaClass.addMethod()
					.setPublic()
					.setName("__"+simpleClassName)
					.setReturnType("State")
					.setBody("//implementation here 2")
//					.addParameter("DefaultStateful", "element")
			;
			...
			javaClass.addMethod()
					...
					.setName("register")
					.setReturnTypeVoid()
					.setBody("__"+simpleClassName+ " = aRegistrationTarget.registerState(new " + simpleClassName +
							"__STX());")
					.addParameter("_RegistrationTarget", "aRegistrationTarget");
