...
import tripleo.elijah_durable_congenial.ci.LibraryStatementPartImpl;
...
import tripleo.elijah_durable_congenial.comp.diagnostic.FileNotFoundDiagnostic;
import tripleo.elijah_durable_congenial.comp.diagnostic.UnknownExceptionDiagnostic;
	...
	private void use_internal(final @NotNull File dir, final boolean do_out, @NotNull LibraryStatementPart lsp) {
		...
		if (files != null) {
			for (final File file : files) {
				...
				REPORTS.addInput(inp, Finally.Out2.ELIJAH);
			}
		}
	}
}
