 ...
 *
 */
package tripleo.elijah_durable_congenial.stages.deduce.declarations;
...
public class DeferredMemberFunction {
	...
	/**
	 * A {@link ClassInvocation} or {@link NamespaceInvocation}.
	 * useless if parent is a {@link DeduceTypes2.OS_SpecialVariable} and its
	 * {@link DeduceTypes2.OS_SpecialVariable#memberInvocation} role value is
