...
import tripleo.elijah.stages.pp.IPP_BaseFunction;
...
public class NG_OutputFunction implements NG_OutputItem {
	...
	public void setFunction(final IPP_BaseFunction aGf, final GenerateFiles ignoredAGenerateFiles, final List<C2C_Result> aCollect) {
		ppf           = aGf;
