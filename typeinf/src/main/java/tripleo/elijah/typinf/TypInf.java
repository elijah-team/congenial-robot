...
public class TypInf {
	 ...
	 * @return
	 */
	static @Nullable HashMap<String, Type> unify_variable(@NonNull TypeVar v, Type typ, @NonNull HashMap<String, Type> subst) {
	...
	private static @NonNull HashMap<String, Type> dict_combine(@NonNull HashMap<String, Type> a, HashMap<String, Type> b) {
	...
	static <K, V> @NonNull HashMap<K, V> mapping(K k, V v) {
	 ...
	 * @return
	 */
	public static HashMap<String, Type> unify_all_equations(@NonNull List<TypeEquation> eqs) {
	 ...
	 * @return
	 */
	public static Type get_expression_type(@NonNull AstNode expr, HashMap<String, Type> subst, boolean rename_types) {
	...
	void show_rec(AstNode node, @NonNull List<String> lines) {
